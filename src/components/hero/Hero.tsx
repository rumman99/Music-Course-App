    ...
    return (
        <div className="h-auto md:h-[40rem] w-full rounded-sm flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0">
            ...
            <div className="p-4 relative z-10 w-full text-center">
                ...
                <p className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">Dive into out comprehensive music courses and transform your musical journey today. Whether you're beginner or looking to refine your skills, joun us to unlock your true potential.</p>
            </div>
            <div>
                <Link href={'/courses'}>
                    <Button
